...
| AWS | [ecs](https://github.com/BishopFox/cloudfox/wiki/AWS-Commands#ecs) | List all ecs tasks. This returns a list of ecs tasks and associated cluster, task definition, container instance, launch type, and associated IAM principal. |
| AWS | [elastic-network-interfaces](https://github.com/BishopFox/cloudfox/wiki/AWS-Commands#eni) | List elastic network interface information. This returns the eni ID, type, external & internal IPs, VPC ID, the attached instance and the description. |
